  ...
  describe 'option validation' do
    describe 'valid options' do
      it 'should not raise any exception' do
        expect { subject.delete_deployment(@options) }.to_not raise_error
      end
    end
    ...
    describe '(cloud_service_name)' do
      it 'should validate cloud service name' do
        ...
        expect { subject.delete_deployment(@options) }.to raise_error(
          ArgumentError,
    ...
    it_behaves_like 'validate authentication credential', :delete_deployment
