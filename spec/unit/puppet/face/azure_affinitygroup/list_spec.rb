  ...
  describe 'option validation' do
    ...
    describe 'valid options' do
      ...
      it 'should print affinity groups details' do
        ...
        expect(affinity_groups).to match(/Name                : #{affinity_group.name}/)
        expect(affinity_groups).to match(/Label               : #{affinity_group.label}/)
        expect(affinity_groups).to match(/Capability          : #{affinity_group.capability}/)
      end
    end
